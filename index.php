...
<body>
    ...
    <main>
        ...
        <div class="hero-area hero-height d-flex align-items-center position-relative" data-background="">
            <img class="hero-shape-5" src="assets/img/shape/shape-02.png" alt="shape">
            <img class="hero-shape-1" src="assets/img/shape/shape-03.png" alt="shape">
            <img class="hero-shape-6" src="assets/img/shape/shape-01.png" alt="shape">
            <img class="hero-shape-7" src="assets/img/shape/shape-10.png" alt="shape">
            ...
            <div class="container">
                <div class="hero-2-content-wrpapper position-relative">
                    <div class="hero-shape-3 d-none d-xl-block">
                        <img class="" src="assets/img/shape/shape-04.png" alt="image not found">
                        <h5 class="slider-shap-text">Top Rated
                            Instructors</h5>
                    </div>
                            ...
                            <div class="slider-content-wrapper">
                                <div class="hero-tittle-info text-center mb-45">
                                    <h2>Build Your Own Online<br>
                                        Platform <span class="down-mark-line-2">Eduman</span></h2>
                                </div>
                                <div class="slider-search ">
                                    <form action="#">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="contact-from-input">
                                                    <input type="submit" class="edu-four-btn" name="lead_sbmit_btn" value="Enroll Now">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="slider-course-content text-center">
                                    <ul>
                                        <li><i class="fas fa-check-circle"></i><span>Free for physically handcraft
                                            </span></li>
                                        <li><i class="fas fa-check-circle"></i><span>Course certificate</span></li>
                                        <li><i class="fas fa-check-circle"></i><span>Easy to enroll courses</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <section class="about-area p-relative pt-90 pb-70">
            <div class="container">
                <img class="about-shape" src="assets/img/shape/education-shape-03.png" alt="shape">
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="about-img position-relative mb-50">
                            ...
                            <img class="about-shape-1" src="assets/img/shape/education-shape-01.png" alt="about">
                            <img class="about-shape-2" src="assets/img/shape/education-shape-02.png" alt="about">
                            <img class="about-shape-3" src="assets/img/shape/education-shape-05.png" alt="about">
                        </div>
                    </div>
                        ...
                        <div class="about-content mb-50">
                            <div class="section-title mb-30">
                                <h2>Increase Your High <br>
                                    Education Level with <span class="down-mark-line-2">Eduman</span>
                                </h2>
                            </div>
                            <div class="student-choose-list">
                                <p class=" mb-30">Helping employees gain skills and providing career development often
                                    take a back seat
                                    to business priorities but workplace. We offer fresh courses on emerging topics that
                                    keep your level.</p>
                                <ul>
                                    <li><i class="fas fa-check-circle"></i>Course curriculum </li>
                                    <li><i class="fas fa-check-circle"></i>Easy to enroll courses</li>
                                    <li><i class="fas fa-check-circle"></i>Know the latest technology</li>
                                </ul>
                            </div>
                            <a class="edu-btn user-btn-sign-up" href="javascript:void(0);">Apply now</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center mb-20">
                        <div class="section-title mb-30">
                            <h2>Top <span class="down-mark-line-2">Categories</span></h2>
                        </div>
                    </div>
                    <div class="">
        ...
        <!-- features-area-start-->
        <div class="features-area margin-top pt-45 pb-15" data-background="assets/img/fact/fact.png">
            <div class="container">
                <div class="row">
        ...
        <!-- teacher-area-start -->
        <section class="teacher-area position-relative pt-120 fix">
            <div class="container">
                        ...
                        <div class="teacher-content mr-20">
                            <div class="section-title mb-30">
                                <h2>Become an Instructor
                                    And <span class="down-mark-line-2">Teach</span> Online</h2>
                            </div>
                            ...
                            <a class="edu-btn btn-transparent mt-25" href="Our-Experts.php">Join us now</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- zooom-class-start -->
        <section class="zoom-area pt-120 pb-60">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-xxl-4 col-xl-5 col-lg-5 order-lg-1">
                        <div class="zoom-class-wrapper mb-60">
                            <div class="section-title mb-30">
                                <h2>Live Class From
                                    Anywhere Via <span class="down-mark-line-2"><a href="javascript:void(0);">Zoom</a></span></h2>
                            </div>
                            ...
                            <a class="edu-btn btn-transparent mt-25" href="javascript:void(0);">Try free now</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="skill-area">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="skill-background-img skill-wrapper" data-background="assets/img/bg/skill.jpg">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-12">
                                    <div class="skill-content">
                                        ...
                                        <a class="edu-four-btn" href="javascript:void(0);">Browse all courses</a>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-12">
