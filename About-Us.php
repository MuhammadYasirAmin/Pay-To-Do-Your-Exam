...
<head>
   ...
   <title>About Us - Education & Online Courses HTML Template</title>
...
<?php include_once 'components/header.php'; ?>
   ...
   <main>
            ...
            <div class="row justify-content-center text-center">
               <div class="col-xl-6 col-md-8">
                  <div class="become-intructor-text">
                     ...
                     <a class="edu-btn" href="become-instructor.html">Get started now</a>
                  </div>
               </div>
            </div>
         </div>
      ...
      <!-- affiliates-area-start -->
      <div class="affiliates-area pt-120 pb-120">
         <div class="container">
            <div class="row">
               <div class="col-xl-12">
