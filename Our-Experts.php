               ...
               <div class="row align-items-center">
                  <div class="col-xl-8 col-lg-8">
                     <div class="header-top-icon">
                        ...
                        <a href="/cdn-cgi/l/email-protection#7c15121a133c19041d110c1019521f1311"><i class="fal fa-envelope"></i><span class="__cf_email__" data-cfemail="b0d9ded6dff0d5c8d1ddc0dcd59ed3dfdd">[email&#160;protected]</span></a>
                              ...
                              <ul>
                                 ...
                                 <li class="menu-item-has-children"><a href="#!">Pages</a>
                                    <ul class="sub-menu">
                                       ...
                                       <li class="menu-item-has-children"><a href="instructor.html">instructor</a>
                                          <ul class="sub-menu">
                                       ...
                                       <li class="menu-item-has-children"><a href="zoom-class.html">zoom class</a>
                                          <ul class="sub-menu">
                                             <li><a href="zoom-class.html">zoom class</a></li>
                     ...
                     <div class="member-body text-center">
                        <div class="member-item">
                           <div class="member-thumb">
                              <a href="instructor-profile.html"><img src="assets/img/member/member-img-01.png"
                                    alt="member-img"></a>
                           </div>
                           <div class="member-content">
                              <h4><a href="instructor-profile.html">Charls David</a></h4>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6">
                  <div class="member-main-wrapper mb-30">
                     <div class="member-body text-center">
                        <div class="member-item">
                           <div class="member-thumb">
                              <a href="instructor-profile.html"><img src="assets/img/member/member-img-02.png"
                                    alt="member-img"></a>
                           </div>
                           <div class="member-content">
                              <h4><a href="instructor-profile.html">Nicholson Ocak</a></h4>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6">
                  <div class="member-main-wrapper mb-30">
                     <div class="member-body text-center">
                        <div class="member-item">
                           <div class="member-thumb">
                              <a href="instructor-profile.html"><img src="assets/img/member/member-img-03.png"
                                    alt="member-img"></a>
                           </div>
                           <div class="member-content">
                              <h4><a href="instructor-profile.html">Miriam Abate</a></h4>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6">
                  <div class="member-main-wrapper mb-30">
                     <div class="member-body text-center">
                        <div class="member-item">
                           <div class="member-thumb">
                              <a href="instructor-profile.html"><img src="assets/img/member/member-img-04.png"
                                    alt="member-img"></a>
                           </div>
                           <div class="member-content">
                              <h4><a href="instructor-profile.html">Vanbrunt Carl</a></h4>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6">
                  <div class="member-main-wrapper mb-30">
                     <div class="member-body text-center">
                        <div class="member-item">
                           <div class="member-thumb">
                              <a href="instructor-profile.html"><img src="assets/img/member/member-img-05.png"
                                    alt="member-img"></a>
                           </div>
                           <div class="member-content">
                              <h4><a href="instructor-profile.html">Anthony Peter</a></h4>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6">
                  <div class="member-main-wrapper mb-30">
                     <div class="member-body text-center">
                        <div class="member-item">
                           <div class="member-thumb">
                              <a href="instructor-profile.html"><img src="assets/img/member/member-img-06.png"
                                    alt="member-img"></a>
                           </div>
                           <div class="member-content">
                              <h4><a href="instructor-profile.html">John Everton</a></h4>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6">
                  <div class="member-main-wrapper mb-30">
                     <div class="member-body text-center">
                        <div class="member-item">
                           <div class="member-thumb">
                              <a href="instructor-profile.html"><img src="assets/img/member/member-img-07.png"
                                    alt="member-img"></a>
                           </div>
                           <div class="member-content">
                              <h4><a href="instructor-profile.html">Joseph Daniyel</a></h4>
                              <span>Sr. Developer, BDevs</span>
                           </div>
                           <div class="member-social">
                              <ul>
                                 <li><a href="#"><i class="fab fa-facebook"></i></a></li>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6">
                  <div class="member-main-wrapper mb-30">
                     <div class="member-body text-center">
                        <div class="member-item">
                           <div class="member-thumb">
                              <a href="instructor-profile.html"><img src="assets/img/member/member-img-08.png"
                                    alt="member-img"></a>
                           </div>
                           <div class="member-content">
                              <h4><a href="instructor-profile.html">Cristina Ena</a></h4>
                              <span>Drawing Expert</span>
                           </div>
                           <div class="member-social">
                              <ul>
                                 <li><a href="#"><i class="fab fa-facebook"></i></a></li>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6">
                  <div class="member-main-wrapper mb-30">
                     <div class="member-body text-center">
                        <div class="member-item">
                           <div class="member-thumb">
                              <a href="instructor-profile.html"><img src="assets/img/member/member-img-09.png"
                                    alt="member-img"></a>
                           </div>
                           <div class="member-content">
                              <h4><a href="instructor-profile.html">Jeanette Harrat</a></h4>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6">
                  <div class="member-main-wrapper mb-30">
                     <div class="member-body text-center">
                        <div class="member-item">
                           <div class="member-thumb">
                              <a href="instructor-profile.html"><img src="assets/img/member/member-img-10.png"
                                    alt="member-img"></a>
                           </div>
                           <div class="member-content">
                              <h4><a href="instructor-profile.html">Satterfield</a></h4>
                              <span>Software Engineer</span>
                           </div>
                           <div class="member-social">
                              <ul>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6">
                  <div class="member-main-wrapper mb-30">
                     <div class="member-body text-center">
                        <div class="member-item">
                           <div class="member-thumb">
                              <a href="instructor-profile.html"><img src="assets/img/member/member-img-11.png"
                                    alt="member-img"></a>
                           </div>
                           <div class="member-content">
                              <h4><a href="instructor-profile.html">Suny Czarnecki</a></h4>
                              <span>Digital Marketer, Conda</span>
                           </div>
                           <div class="member-social">
                              <ul>
                                 <li><a href="#"><i class="fab fa-facebook"></i></a></li>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6">
                  <div class="member-main-wrapper mb-30">
                     <div class="member-body text-center">
                        <div class="member-item">
                           <div class="member-thumb">
                              <a href="instructor-profile.html"><img src="assets/img/member/member-img-12.png"
                                    alt="member-img"></a>
                           </div>
                           <div class="member-content">
                              <h4><a href="instructor-profile.html">Vickie Garza</a></h4>
                              <span>Musician & Vocalist</span>
                           </div>
                           <div class="member-social">
                              <ul>
                                 <li><a href="#"><i class="fab fa-facebook"></i></a></li>
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="footer-widget f-w1 mb-40">
                        <div class="footer-img">
                           <a href="index.html"> <img src="assets/img/logo/footer-logo.png" alt="footer-logo"></a>
